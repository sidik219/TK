                    ...
                    <form class="md-float-material form-material">
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="row m-t-25 text-left">
                                    <div class="col-12">
                                        ...
                                        <div class="forgot-phone text-right float-right">
                                            <a href="auth_reset_password.php" class="text-right f-w-600"> Lupa Password?</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <p class="text-inverse text-left">Tidak punya akun?<a href="auth_daftar.php"> <b>Daftar disini </b></a>gratis!</p>
                            </div>
                        </div>
                    </form>
                </div>
...
<script type="4878d7dfa7bc22a8dfa99416-text/javascript" src="../../js/waves.min.js"></script>
